...
#        footer_shape = slide.shapes.add_textbox(left=Inches(9), top=Inches(7.2), width=Inches(1.0), height=Inches(0.3))
...
def add_page_numbers(prs):
    for slide in prs.slides:
        ...
        #footer_shape = slide.shapes.add_textbox(left=Inches(1.5), top=Inches(7.2), width=Inches(7.0), height=Inches(0.2))
        #text_frame = footer_shape.text_frame
        #text_frame.clear()  # Clear any existing text
        #p = text_frame.paragraphs[0]
        ...
        # Set the text to the slide number
        #p.text = f"{prs.slides.index(slide) + 1}"
        #p.text = "@copyright Belcan India Pvt Ltd"
        # Set font properties
        #run = p.runs[0]
        #font = run.font
        #font.size = Pt(8)
